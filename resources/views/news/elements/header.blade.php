@php
    ...
    if(count($itemsCategory) > 0){
        ...
        foreach ($itemsCategory as $item) {
            ...
            $categoryActive = ($categoryIdCurrent == $item['id']) ? 'class = "active"' : '';
            
            $xhtmlMenu .= sprintf('<li %s><a href="%s">%s</a></li>', $categoryActive, $link, $item['name']);
                    ...
                    <div class="header_content d-flex flex-row align-items-center justfy-content-start">
                        ...
                        <div class="header_extra ml-auto d-flex flex-row align-items-center justify-content-start">
                            <a href="#">
                                ...
                                style="background-image:url({{asset('images/zendvn-online.png')}});background-size: contain"></div>
                            </a>
                        </div>
                    </div>
                </div>
